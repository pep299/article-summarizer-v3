...
func TestLobstersHandler_ServeHTTP_PostMethod(t *testing.T) {
	...
	handler := NewLobstersHandler(
		&mocks.MockLobstersRSSRepo{},
	...
	req := httptest.NewRequest("POST", "/process/lobsters", nil)
